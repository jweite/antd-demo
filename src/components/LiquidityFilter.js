...
export class LiquidityFilter extends Component {
	...
	render() {
		return <div>
			...
			{!this.state.isCollapsed && <Slider min={0} max={100} range={true} defaultValue={this.vals} disabled onChange={this.onChange} onAfterChange={this.props.onFilterChanged}/> }
		</div>
	}
}
